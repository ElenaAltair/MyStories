...
object ShareHelperChapter {
    fun shareChapter(chapter: ChapterEntity2, listName: String, context: Context): Intent {
        val intent = Intent(Intent.ACTION_SEND)
        intent.type = "text/plane"
        intent.apply {
            putExtra(Intent.EXTRA_TEXT, makeShareText(chapter, listName, context))
        }
        return intent
    }

    fun makeShareText(chapter: ChapterEntity2, listName: String, context: Context): String {
