...
object ShareHelperTerm {
    fun shareTerm(term: TermEntity2, listName: String, context: Context): Intent {
        val intent = Intent(Intent.ACTION_SEND)
        intent.type = "text/plane"
        intent.apply {
            putExtra(Intent.EXTRA_TEXT, makeShareText(term, listName, context))
        }
        return intent
    }

    fun makeShareText(term: TermEntity2, listName: String, context: Context): String {
