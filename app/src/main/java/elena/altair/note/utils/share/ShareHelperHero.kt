...
object ShareHelperHero {
    fun shareHero(hero: HeroEntity2, listName: String, context: Context): Intent {
        val intent = Intent(Intent.ACTION_SEND)
        intent.type = "text/plane"
        intent.apply {
            putExtra(Intent.EXTRA_TEXT, makeShareText(hero, listName, context))
        }
        return intent
    }

    fun makeShareText(hero: HeroEntity2, listName: String, context: Context): String {
